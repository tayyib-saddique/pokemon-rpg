...
class NavGrid:
    ...
    def find_path(self, start_world, goal_world):
        ...
        print("GRID SIZE:", self.cols, self.rows)
        ...
        print("WALKABLE:", walkable, "BLOCKED:", blocked)

        # -------------------------
        # BLOCK CHECKS
        # -------------------------
        print("START NODE BLOCKED?", matrix[start[1]][start[0]] == 0)
        print("GOAL NODE BLOCKED?", matrix[goal[1]][goal[0]] == 0)
